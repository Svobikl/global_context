...
#modelFile = "/media/data/Workspace/LexVec/lexvec.enwiki+newscrawl.300d.W.pos.vectors"
if __name__ == '__main__':
    ...
    acc =model.accuracy("/media/data/korpusy/Trained/categories/questions-words.txt", restrict_vocab=300000)
