...
modelFile = "/home/svobik/build-W2V-clean-Desktop_Qt5_5_0_PythonGDB-Debug/new2.bin"
if __name__ == '__main__':
    ...
    acc =model.accuracy("/media/data/korpusy/Trained/categories/czech_emb_corpus_no_phrase.txt", restrict_vocab=300000)
