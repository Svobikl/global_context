...
modelFile = "/media/data/korpusy/Croatian/fastTextCR-skipL.vec"
if __name__ == '__main__':
    ...
    #last_item = acc[-1]
    #fw.write("questions OOV rate (%d,%d,%d)\n" % (last_item['questions_total'],last_item['syn_questions'],last_item['OOV_questions']))
    #fw.write("---------\n")
